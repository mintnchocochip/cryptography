...
if __name__ == "__main__":
    ...
    key, cipher_hex = payload.split(":", 1)
    plaintext, logs = decrypt(cipher_hex, key)
    print("Received Cipher Text:", cipher_hex)
    print("Intermediate Results(IP, Round 1, 2......16, ) in HEX format")
    for idx, steps in enumerate(logs):
